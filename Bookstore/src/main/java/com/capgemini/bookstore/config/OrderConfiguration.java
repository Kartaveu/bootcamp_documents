...
@Configuration
@EnableSwagger2
public class OrderConfiguration extends WebMvcConfigurationSupport{
	 @Bean
	    public Docket version1() {
	        return new Docket(DocumentationType.SWAGGER_2).select()
	                ...
	                .groupName("BookStore")
	                .apiInfo(new ApiInfoBuilder().description("BookStore APIs")
	                        .title("OnlineBookStore").version("1.0.0.0").build());
}
